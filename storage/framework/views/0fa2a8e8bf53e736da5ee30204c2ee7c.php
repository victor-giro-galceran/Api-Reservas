...
<?php $__env->startSection('content'); ?>
    ...
    <div class="max-w-7xl mx-auto p-6 lg:p-8">
        ...
        <div class="relative p-4 bg-white rounded-lg shadow dark:bg-gray-800 sm:p-5">
            ...
            <form method="POST" id="form-create" action="<?php echo e(route('zones.store')); ?>">
...
<?php echo $__env->make('master.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\Reservation-System\resources\views/zones/create.blade.php ENDPATH**/ ?>
        ...
        <div class="max-w-2xl overflow-hidden bg-white shadow sm:rounded-lg mx-auto">
            ...
            <div class="flex justify-between mb-4 rounded-t sm:mb-5">
                ...
                <div>
                    ...
                    <a type="button" href="{{ route('zones.index') }}" class="text-gray-400 bg-transparent hover:bg-gray-200 hover:text-gray-900 rounded-lg text-sm p-1.5 inline-flex dark:hover:bg-gray-600 dark:hover:text-white" data-modal-toggle="readProductModal">

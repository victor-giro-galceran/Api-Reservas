                ...
                <div class="flex items-center p-4 bg-white rounded-lg shadow-xs dark:bg-gray-800">
                    ...
                    <div>
                        ...
                        <p class="text-lg font-semibold text-gray-700 dark:text-gray-200">
                            @foreach ($reserve_count_by_state as $reserve_count)
                                @if ($reserve_count->state === 'Approved')
                                    {{ $reserve_count->count }}
                                @endif
                            @endforeach
                        </p>
            ...
            <div class="overflow-hidden rounded-lg border border-gray-200 shadow-md">
                ...
                <div class="flex items-center p-4 bg-white rounded-lg shadow-xs dark:bg-gray-800">
                    ...
                    <div>
                        ...
                        <p class="text-lg font-semibold text-gray-700 dark:text-gray-200">
                            @foreach ($reserve_count_by_state as $reserve_count)
                                @if ($reserve_count->state === 'Rejected')
                                    {{ $reserve_count->count }}
                                @endif
                            @endforeach
                        </p>
            ...
            <div class="overflow-hidden rounded-lg border border-gray-200 shadow-md">
                ...
                <div class="flex items-center p-4 bg-white rounded-lg shadow-xs dark:bg-gray-800">
                    ...
                    <div>
                        ...
                        <p class="text-lg font-semibold text-gray-700 dark:text-gray-200">
                            @foreach ($reserve_count_by_state as $reserve_count)
                                @if ($reserve_count->state === 'Requested')
                                    {{ $reserve_count->count }}
                                @endif
                            @endforeach
                        </p>
            ...
            <div class="overflow-hidden rounded-lg border border-gray-200 shadow-md">
                ...
                <div class="flex items-center p-4 bg-white rounded-lg shadow-xs dark:bg-gray-800">
                    ...
                    <div>
                        ...
                        <p class="text-lg font-semibold text-gray-700 dark:text-gray-200">
                            @foreach ($reserve_count_by_state as $reserve_count)
                                @if ($reserve_count->state === 'Scheduled')
                                    {{ $reserve_count->count }}
                                @endif
                            @endforeach
                        </p>
            ...
            <div class="overflow-hidden rounded-lg border border-gray-200 shadow-md">
                ...
                <div class="flex items-center p-4 bg-white rounded-lg shadow-xs dark:bg-gray-800">
                    ...
                    <div>
                        ...
                        <p class="text-lg font-semibold text-gray-700 dark:text-gray-200">
                            @foreach ($reserve_count_by_state as $reserve_count)
                                @if ($reserve_count->state === 'Cancelled')
                                    {{ $reserve_count->count }}
                                @endif
                            @endforeach
                        </p>
            ...
            <div class="overflow-hidden rounded-lg border border-gray-200 shadow-md">
                ...
                <div class="flex items-center p-4 bg-white rounded-lg shadow-xs dark:bg-gray-800">
                    ...
                    <div>
                        ...
                        @php $total_count = $reserve_count_by_state->sum('count'); @endphp
                ...
                <thead class="bg-gray-50">
                    <tr>
                        ...
                        <th scope="col" class="px-6 py-4 font-medium text-gray-900">
                            <a href="{{ route('reserves.create') }}" class="bg-transparent hover:bg-green-200 rounded-lg text-sm p-1.5 inline-flex dark:hover:bg-gray-600">Create</a>
                        </th>
                    </tr>
                </thead>
                ...
                <tbody class="divide-y divide-gray-100 border-t border-gray-100">
                    ...
                    @foreach ($reserves as $reserve)
                        ...
                        <tr class="hover:bg-gray-50">
                            ...
                            <th class="px-6 py-4 font-medium text-gray-900">{{ $reserve->email }}</th>
                            <td class="px-6 py-4">{{ $reserve->date }}</td>
                            
                            <!-- Zone column -->
                            <td class="px-6 py-4">{{ $reserve->zone }}</td>
                            ...
                            <td class="px-6 py-4">
                                ...
                                @endphp
                                @if (is_array($services)) <!-- Make sure $services is an array before iterating -->
                                    ...
                                    <div class="flex items-center">
                                        ...
                                        @foreach ($services as $service)
                                            ...
                                            @elseif ($service === 'Open Bar & Snacks')
                            ...
                            <td class="px-6 py-4">
                                ...
                                @elseif ($reserve->state === 'Scheduled')
                                ...
                                @elseif ($reserve->state === 'Requested')
                            ...
                            <td class="px-6 py-4">
                                ...
                                <a href="{{ route('reserves.show', $reserve->id) }}" class="text-danger text-primary-700 bg-transparent hover:bg-blue-200 rounded-lg text-sm p-1.5 inline-flex dark:hover:bg-gray-600">Show</a>
                                <a href="{{ route('reserves.edit', $reserve->id) }}" class="text-danger text-primary-700 bg-transparent hover:bg-yellow-200 rounded-lg text-sm p-1.5 inline-flex dark:hover:bg-gray-600">Edit</a>

                                {{-- <!--<form action="{{ route('reserves.destroy', $reserve->id) }}" method="POST" class="inline">
        ...
        <div class="flex items-center justify-between mt-6">
            ...
            @if ($reserves->hasPages())
                ...
                <div class="items-center hidden md:flex gap-x-3">
                    @foreach ($reserves->links()->elements[0] as $page => $url)
                        <a href="{{ $url }}" class="px-2 py-1 text-sm {{ $reserves->currentPage() == $page ? 'text-blue-500 bg-blue-100/60' : 'text-white-500 hover:bg-white-100' }} rounded-md dark:hover:bg-gray-800 dark:text-white-300 rounded-lg border border-white-200 shadow-md">{{ $page }}</a>
                    @endforeach
                </div>
